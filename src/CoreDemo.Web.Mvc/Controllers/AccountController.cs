...
using CoreDemo.Sessions;
using CoreDemo.Web.Models.Account;
using CoreDemo.Web.Views.Shared.Components.TenantChange;

namespace CoreDemo.Web.Controllers
{
    public class AccountController : CoreDemoControllerBase
    {
